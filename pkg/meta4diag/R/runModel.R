runModel <- function(outdata, outpriors, link="logit", level = c(0.025, 0.5, 0.975), verbose=FALSE){
...
#   }
  ...
  if(!outpriors$wishart.flag){
    ...
    model = INLA::inla(fm, family="binomial", data=data, Ntrials=Ntrials, quantiles=level,
